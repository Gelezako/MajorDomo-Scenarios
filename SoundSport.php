...
if($params['exercises']=='подтянулся' or $params['exercises']=='подтягиванию' or $params['exercises']=='подтягивание'){sg("Pullup.Quantity",$params['number']);say("Готово, записано ".$params['number'],2);}
